...
function Auth() {
  ...
  return (
    <>
      <div className="w-full relative h-screen flex justify-center items-center bg-black bg-opacity-60 transition-opacity">
        <LoginAs />
            ...
            <div className="flex flex-col w-full space-y-4 p-1">
              ...
              <div className="flex flex-col w-full pt-6">
                ...
                >
                  ...
                  <span>{loginLoading ? "Loading" : authType}</span>
                </button>
              </div>
